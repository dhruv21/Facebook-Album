    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                <li>
                    <a href="login.php" id="nav-text-link">
                       <span class="glyphicon glyphicon glyphicon-home"> </span> Home
                    </a>
                </li>
                <li>
                    <a href="download-album.php" id="nav-text-link">
                        <span class="glyphicon glyphicon-cloud-download"></span> Download 
                    </a>
                </li>
                <li>
                    <a href="upload-album.php" id="nav-text-link">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="logout.php" id="nav-text-link">
    ...
    <div class="row" id="user-data-body">
        ...
        <div class="col-xs-8 col-md-offset-1" id="user-data">
          ...
          <h3 class="text-primary">
              <?php echo $_SESSION['userData']['first_name']; echo " ". $_SESSION['userData']['last_name'];?>
          </h3>
          <p class="text-primary">
            <?php if(isset($_SESSION['userData']['email'])){echo $_SESSION['userData']['email'];} ?> 
            </p>
        </div>
    </div>
</div>
